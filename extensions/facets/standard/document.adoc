:Title: OGC API - Records - Part 2: Facets
:titletext: OGC API - Records - Part 2: Facets
:doctype: standard
:encoding: utf-8
:status: draft
:committee: technical
:draft: 1.0
:external-id: http://www.opengis.net/doc/IS/ogcapi-records-2/1.0
:docnumber: 25-013
:lang: en
...
:fullname_2: Florent Gravin
:fullname_3: Paul van Genuchten
:fullname_4: Panagiotis (Peter) A. Vretanos
:fullname_5: Angelos Tzotsos
:docsubtype: Interface
:keywords: ogcdoc, OGC document, OGC API, catalog, record, records, resource, metadata, discovery, facets, aggregations, buckets
:submitting-organizations: Meteorological Service of Canada; Camptocamp SA; ISRIC - World Soil Information; CubeWerx Inc., Open Source Geospatial Foundation
...
|Approval Date: 2025-03-31
|Publication Date: 2025-03-31
|External identifier of this OGC(R) document: http://www.opengis.net/doc/is/ogcapi-records-2/1.0
|Internal reference number of this OGC(R) document: 25-013
|Version: 1.0.0-draft.1
|Category: OGC(R) Implementation Standard
|Editors:  Tom Kralidis, Florent Gravin, Paul van Genuchten, Panagiotis (Peter) A. Vretanos, Angelos Tzotsos
|===
...
include::clause_7_simple_facets.adoc[]

include::clause_8_advanced_facets.adoc[]

include::clause_9_security.adoc[]
