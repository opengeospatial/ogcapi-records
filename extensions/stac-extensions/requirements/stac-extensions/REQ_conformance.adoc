[[req_stac-extensions_conformance]]

[requirement]
====
[%metadata]
identifier:: /req/stac-extensisons/conformance
...
part:: An implementation of a server that supports the use of STAC extensions in records SHALL declare the following conformance classes in the conformance declaration:
+
