:Title: DRAFT OGC API - Records - Part 2: Collections
:titletext: DRAFT OGC API - Records - Part 2: Collections
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|Internal reference number of this OGC(R) document: 21-046
|Version: 0.0.1
...
include::clause_8_sorting.adoc[]

include::clause_9_cql.adoc[]

include::clause_10_opensearch.adoc[]

include::clause_11_encodings.adoc[]

include::clause_12_media_types.adoc[]

include::clause_13_security.adoc[]
