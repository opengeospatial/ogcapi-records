...
|Target type |Web API
|Dependency |https://docs.ogc.org/DRAFTS/20-004r1.html#clause-searchable-catalog[OGC API - Records - Part 1: Core, Requirements Class "Searchable Catalog"]
...
|Conditional Dependency |https://docs.ogc.org/DRAFTS/20-004r1.html#requirements-class-json-clause[OGC API - Records - Part 1: Core, Requirements Class "JSON"]
