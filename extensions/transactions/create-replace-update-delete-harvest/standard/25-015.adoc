:Title: [DRAFT] OGC API - Records - Part 3: Create, Replace, Update, Delete, Harvest
:titletext: [DRAFT] OGC API - Records - Part 3: Create, Replace, Update, Delete, Harvest
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/ogcapi-records-3/1.0
|Internal reference number of this OGC(R) document:    25-015
|Version: 1.0.0-draft
|Latest Published Draft: n/a
|Category: OGC(R) Implementation Standard
|Editors: Panagiotis (Peter) A. Vretanos, Tom Kralidis, Angelos Tzotsos
|===
...
include::clause_6_records.adoc[]

include::clause_7_harvest.adoc[]
