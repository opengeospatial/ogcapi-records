...
This section defines how to access the collection resource through the Records API.
...
include::requirements/record-api/REQ_record-collection-op.adoc[]
...
include::requirements/record-api/REQ_query-param-bbox.adoc[]
...
include::requirements/record-api/REQ_query-param-datetime.adoc[]
...
include::requirements/record-api/REQ_query-param-limit.adoc[]

[[core-query-parameters-q]]
===== Parameter q

include::requirements/record-api/REQ_query-param-q-definition.adoc[]

include::recommendations/record-api/REC_param-q.adoc[]

include::requirements/record-api/REQ_query-param-q-response.adoc[]

[[core-query-parameters-type]]
===== Parameter type

include::requirements/record-api/REQ_query-param-type-definition.adoc[]

include::recommendations/record-api/REC_query-param-type-definition.adoc[]

include::requirements/record-api/REQ_query-param-type-response.adoc[]

[[core-query-parameters-externalid]]
===== Parameter externalId

include::requirements/record-api/REQ_query-param-externalid-definition.adoc[]

include::requirements/record-api/REQ_query-param-externalid-response.adoc[]
...
include::recommendations/record-api/REC_additional-query-parameters.adoc[]
...
include::requirements/record-api/REQ_record-collection-response.adoc[]
...
include::requirements/record-api/REQ_record-op.adoc[]

==== Response

include::requirements/record-api/REQ_record-success.adoc[]
