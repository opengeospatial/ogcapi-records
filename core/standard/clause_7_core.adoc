...
|links |O |A list of links for navigating the API (e.g. link to previous or next pages; links to alterntive representations, etc.) |links
|===
...
|associations |O |A list of links for accessing the resource, links to other resources associated with this resource, etc. |properties.associatations
|===
