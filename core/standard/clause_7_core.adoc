...
include::recomendations/core/PER_additional-conformance.adoc[]
...
The query parameters `type`, `q`, `externalids` and `sortby` are specific to API - Records.
...
include::requirements/core/REQ_rc-bbox-parameter.adoc[]
...
include::requirements/core/REQ_rc-limit-parameter.adoc[]

[[core-query-parameters-type]]
===== Parameter type

include::requirements/core/REQ_rc-type-definition.adoc[]

include::requirements/core/REQ_rc-type-response.adoc[]

[[core-query-parameters-q]]
===== Parameter q

include::requirements/core/REQ_rc-q-definition.adoc[]

include::requirements/core/REQ_rc-q-case-definition.adoc[]

include::requirements/core/REQ_rc-q-response.adoc[]

===== Parameter externalids

include::requirements/core/REQ_rc-extids-definition.adoc[]

include::requirements/core/REQ_rc-extids-response.adoc[]

[[core-query-parameters-sortby]]
===== Parameter sortby

include::requirements/core/REQ_rc-sortby-definition.adoc[]

include::requirements/core/REQ_rc-sortby-response.adoc[]

include::requirements/core/REQ_sortables-op.adoc[]

include::requirements/core/REQ_sortables-success.adoc[]

[#sortby-example,reftext=`SortBy Example`]
.sortby Example
[source]
----
.../collections/mycat/items?...&sortby=modified:desc,recordid&...
----
...
[source]
----
.../collections/mycat/items?...&sortby=extent:asc&...
----
...
include::recomendations/core/PER_additional-properties.adoc[]

[[core-queryables-table]]
[#core-queryables,reftext='{table-caption} {counter:table-num}']
.Table of Core Queryables
[cols="20,40,40",options="header"]
|===
|Queryables |Requirement |Description
|id |M |A unique record identifier assigned by the server.
|created |M |The date this record was created in the server.
|changed |M |The most recent date on which the record was changed.
...
|associations |O |A list of links for accessing the resource or links to other resources associated with this resource.
|===
