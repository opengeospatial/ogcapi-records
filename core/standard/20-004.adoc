...
include::clause_7_autodiscovery.adoc[]

include::clause_8_crawlable_catalogue.adoc[]

include::clause_9_searchable_catalogue.adoc[]

include::clause_10_local_resources_catalogue.adoc[]

include::clause_11_record_collection.adoc[]

include::clause_12_record_core.adoc[]

include::clause_13_record_api.adoc[]
