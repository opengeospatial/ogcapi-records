...
The canonical of selecting a desired response encoding is to use https://datatracker.ietf.org/doc/html/rfc7231#section-3.4[HTTP content negotiation].  However, content negotiation is not required by the HTTP standard.  Therefore, default encodings must be established.

include::requirements/record-core/REQ_default-mediatype.adoc[]

include::requirements/record-collection/REQ_default-mediatype.adoc[]
