...
==== GeoJSON
"GeoJSON is a geospatial data interchange format based on JavaScript Object Notation (JSON). It defines several types of JSON objects and way they are combined to represent data about geographic features, their properties, and their spatial extents. GeoJSON uses a geographic coordinate reference system, World Geodetic System 1984, and units of decimal degrees." <<GeoJSON,IETF RFC 7946>>
...
A description of the MIME types is mandatory for any OGC Standard which involve data encodings. The list of suitable MIME types for the OGC API - Records Standard is provided in <<media-types-table>>.
