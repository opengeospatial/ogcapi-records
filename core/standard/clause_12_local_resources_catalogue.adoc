...
This conformance class specifies requirements for a _local resource catalogues_.
...
2. define or extend the set of query parameters avaiable at the local resources endpoint (e.g. `/collections`) to enhance it searchability.

This conformance class does not define the specific endpoints in the OGC API resource tree that should be enabled with catalogue-like query capabilities.  It only defines how those endpoint should be enhanced should the requirement for catalogue-line searching be identified by the responsible OGC standard.
...
To enable search capabilities at local resource endpoints, this conformance class defines the a set of requirements and recommendations around query parameters that can implemented at the endpoint.
...
[[clause_local-resources-catalogue_sorting]]
...
[[clause_local-resources-catalogue_advanced-filter]]
=== Requirements Class "Local Resources Catalogue, Advanced Filtering"

include::requirements/requirements_class_local-resources-catalogue_advanced-filter.adoc[]
...
include::requirements/local-resources-catalogue_advanced-filter/REQ_filter-param.adoc[]

include::requirements/local-resources-catalogue_advanced-filter/REQ_filter-lang-param.adoc[]

include::recommendations/local-resources-catalogue_advanced-filter/REC_text-encoding.adoc[]

include::recommendations/local-resources-catalogue_advanced-filter/REC_json-encoding.adoc[]

include::requirements/local-resources-catalogue_advanced-filter/REQ_filter-crs-param.adoc[]

==== Response

include::requirements/local-resources-catalogue_advanced-filter/REQ_filter-response.adoc[]
