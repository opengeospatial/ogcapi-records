...
include::requirements/local-resources-catalogue/REQ_conformance.adoc[]
  ...
  allOf:
    ...
    - type: object
      ...
      properties:
        type:
          description: 
            The nature or genre of the items of the collections (e.g. feature,
            coverage)
          type: string
        created:
          description:
...
TODO Should add an instance example of a collection object.
...
[[local-resources-catalogue-bbox-param]]
==== Parameter bbox
...
[[local-resources-catalogue-datetime-param]]
==== Parameter datetime
...
[[local-resources-catalogue-limit-param]]
==== Parameter limit
...
[[local-resources-catalogue-q-param]]
==== Parameter q
...
include::requirements/local-resources-catalogue/REQ_param-q-response.adoc[]

[[local-resources-catalogue-type-param]]
==== Parameter type
...
[[local-resources-catalogue-additional-params]]
...
include::requirements/local-resources-catalogue/REQ_response.adoc[]
...
include::requirements/local-resources-catalogue_sorting/REQ_conformance.adoc[]
...
include::requirements/local-resources-catalogue_cql2-filter/REQ_conformance.adoc[]
