...
NOTE: The term _local resources endpoint_ is used to refer to the resource path of the _local resources catalogue_.  The term _local resources object_ is used to refer to an instance of the object or resource that can be retrieved from the _local resources endpoint_.
...
include::recommendations/local-resources-catalogue/REC_property-description.adoc[]

include::recommendations/local-resources-catalogue/PER_common-mark.adoc[]

=== Property `extent`

include::requirements/local-resources-catalogue/REQ_property-extent.adoc[]

include::recommendations/local-resources-catalogue/PER_property-extent-null.adoc[]

=== Property `links`

include::requirements/local-resources-catalogue/REQ_property-links.adoc[]

=== Property `created`

include::recommendations/local-resources-catalogue/REC_property-created.adoc[]

=== Property `updated`

include::recommendations/local-resources-catalogue/REC_property-updated.adoc[]
...
include::recommendations/local-resources-catalogue/REC_property-keywords.adoc[]
