...
^|B |The list of other languges in which the collection object may be retrieved SHOULD be specified using the <<collection-properties-table,`languages`>> property.
