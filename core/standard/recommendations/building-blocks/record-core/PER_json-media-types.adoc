...
Record or catalog resources MAY be accompanied by generic media types. Thus a JSON-encoded record or catalog resource MAY be accompanied by an `application/json` media type.
|===
