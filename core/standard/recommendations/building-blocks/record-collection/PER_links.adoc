...
part:: The links in the `links` section of a catalog may be typed (i.e. include the `type` member) to allow for the possibility of alternate representations for each record and/or subordinate catalog.
====