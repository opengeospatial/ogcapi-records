...
|===
|Queryables |Requirement |Description |GeoJSON key
|geometry |**required** |A geometry associated with the resource that is used for discovery.  Can be null is there is not associated geometry |geometry
...
|keywordsCodespace |optional |A reference to a controlled vocabulary used for the keywords property. |properties.keywordsCodespace
