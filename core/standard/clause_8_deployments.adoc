...
1. enhance the information content of each local resources object  (e.g. the `/collection/{collectionId}` object) with additional members from the list of <<core-properties,core record properties>>.
...
include::requirements/local-resources-catalog/REQ_property-geometry.adoc[]

include::recommendations/local-resources-catalog/REC_property-geometry.adoc[]
