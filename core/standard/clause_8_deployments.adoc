...
1. Extends the information content of the local resources catalog to satisfy the requirements of the <<clause-record-collection,Record Collection>> building block.

2. Extends the information content of the local resources item to satisfy the requirements of the <<clause-record-core,Record Core>> building block.
