...
The `q` parameter is meant to provide a simple, easy to implement keyword search capability across one or more text fields in a record.  The specific text fields in a record that are to be searched are not mandated in this standard.
