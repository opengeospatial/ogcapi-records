...
|_**crs**_ |optional |A list of coordinate reference systems used for spatialtemporal values.
...
|<<core-query-parameters-type,type>> |An equality predicate consisting of a comma-separated list of resource types.  Only records of the listed type shall appear in the resource set.
