...
The following example uses links and link templates to point to resources related to a record.  The `describes` links can be used to retrieve the resources described by the record.  Other links, such as `enclosure`, can be used to retrieve the same information is archived formats.
