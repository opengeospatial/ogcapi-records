...
This requirements class defines the requirements for a collection.

In the context of this specification, a collection is an object that provides information about and access to a set of related <<clause-core-record,records>> also known as a catalogue.  You can think of the collection resource as a record that describes the catalogue.
...
|_**crs**_ |optional |A list of coordinate reference system used for spatial-temporal values.
|type |**required** |The nature or genre of the resource. Fixed to "Collection".
|keywords |optional |A list of keywords or tag associated with the collection.
|keywordsCodespace |optional |A reference to a controlled vocabulary used for the keywords property.
|language |optional |This refers to the natural language used for textual values (i.e. titles, descriptions, etc) of a collection.
...
|providers |optional |A list of provided qualified by their role.
