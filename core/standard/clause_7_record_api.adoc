...
|sortby |Record sorting for response
|filter/filter_lang/filter_crs |Parameter from Features Part 3 for CQL filtering
2+|NOTES:  1. Inherited from http://docs.opengeospatial.org/is/17-069r3/17-069r3.html[OGC API - Features - Part 1: Core].
|===
