...
Although not described in this specification, a deeper tree strcture of linked collection objects can be used to organize hierarchies of collections and records.
