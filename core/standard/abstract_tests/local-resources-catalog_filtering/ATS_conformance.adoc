[[ats_local-resources-catalog_filtering_conformance]]
[width="90%",cols="2,6a"]
|===
...
. Check that the `+conformsTo+` array contains the value `+http://www.opengis.net/spec/ogcapi-records-1/1.0/conf/local-resources-catalog_cql2-filter+`.
|===
