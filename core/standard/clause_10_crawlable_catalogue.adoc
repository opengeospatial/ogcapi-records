...
NOTE: It should be pointed out that a <<clause-searchable-catalogue,searchable catalogue>> can also behave as a crawlable catalogue as long as the requirements in this clause are satisfied by the <<lause-searchable-catalogue,searchable catalogue>> implementation.

[[crawlable-catalogue-record]]

include::requirements/crawlable-catalogue/REQ_conformance.adoc[]
...
|license |optional |The legal provisions under which this collections object is made available.
