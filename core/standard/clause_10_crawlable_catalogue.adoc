...
|keywords |optional |A list of keywords or tag associated with this collections object.
|keywordsCodespace |optional |A reference to a controlled vocabulary used for the keywords property.
|language |optional |This refers to the natural language used for textual values (i.e. titles, descriptions, etc) of this collections object.
...
|contactPoint |optional |An entity to contact about this collections object.
