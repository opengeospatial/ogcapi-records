...
^|D |Search terms that are to be AND'ed SHALL be separated by one or more white spaces and must appear in the text of the record separated by any number of white spaces and in the order presented.
