...
^|A |The schema of a collection (collectionInfo.yaml) SHALL be extended with the addition of the `defaultSortOrder` member with the following characteristics (using an OpenAPI Sepcification 3.0 fragment):
