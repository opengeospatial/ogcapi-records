...
part:: All references to the term "features" in the https://docs.ogc.org/is/17-069r4/17-069r4.html#_parameter_bbox[OGC API - Features - Part 1: Core] Standard SHALL be replaced by the term "record" or "local resource" as the context may indicate.
====