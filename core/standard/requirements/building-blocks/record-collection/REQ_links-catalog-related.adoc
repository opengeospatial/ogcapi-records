...
part:: A catalog referencing another related catalog in an unorganized set of catalogs SHALL include a link (relation: `related`) pointing to the related catalog.
====