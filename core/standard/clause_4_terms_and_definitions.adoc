...
[[record-def]]
=== Record
atomic unit of information of a catalog that is used to provide information about a particular resource that the publisher of that resources wishes to make discoverable
