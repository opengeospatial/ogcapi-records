...
=== OGC API Resource tree
a collection of resources defined by the set of https://ogcapi.ogc.org/[OGC API Standards] that are hierarchically organized and exposed through a root node that is common to all OGC APIs
